...
function Muscle(id, muscle_name, muscle_group_FK) {
    ...
    this.muscle_group_FK = muscle_group_FK;
}
...
const getData = async () => {
      ...
      const res = await fetch(
        ...
        MUSCLES_API_URL,
        {
          ...
          body: JSON.stringify({
              ...
              muscle_group_FK: data.muscle_group_FK
          }),
          headers: {
  ...
  function updateButtonAPICall(tdElementsArray) {
    let data = {
        ...
        muscle_group_FK: tdElementsArray[2].firstChild.value,
    };
  ...
  function addButtonSendAPICall() {
    ...
    addButton.addEventListener("click", () => {
      ...
      let data = {
        ...
        muscle_group_FK: formElement[1].value,
      };
