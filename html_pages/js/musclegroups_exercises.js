function MuscleGroups_Exercises(muscle_group_id, exercise_id) {
...
function createTable(dataRowsArray) {
    let tableElement = document.querySelector("#many_to_many_table");
...
function main() {
    let musclegroups_exercises_array = [
        new MuscleGroups_Exercises(
            1,
            3
        ),
        new MuscleGroups_Exercises(
    ...
    createTable(musclegroups_exercises_array);
    clearFormInputs();
